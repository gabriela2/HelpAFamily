...
namespace HelpAFamily.Controllers
{
    ...
    public class UsersController : Controller
    {
        ...
        {
            var dataContext = _context.Users.Include(u => u.RoleTypes).Include(u => u.UserTypes);
        ...
        public async Task<IActionResult> Create([Bind("Id,Email,Username,FirstName,LastName,PasswordHash,PasswordSalt,RoleTypeId,UserTypeId")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Email,Username,FirstName,LastName,PasswordHash,PasswordSalt,RoleTypeId,UserTypeId")] User user)
        {
            if (id != user.Id)
            {
                return NotFound();
